...
var icon_enabled: bool = false: set = enable_icon
var texture: Texture = null: set = set_texture
# var size: Vector2 = Vector2(24, 24): set = _set_size

var text: String = "": set = set_text
var placeholder: String = "": set = set_placeholder
var input_name: String = "Input Name": set = set_input_name
var show_name: bool = true: set = set_show_name
var optional_name: String = "": set = set_optional_name
var description: String = "Description": set = set_description
var show_description: bool = false: set = set_show_description

var pressing: bool = false
var secret: bool = false: set = set_secret
...
func _connect_signals():
	$Container/InputContainer/Box/Text.connect("focus_entered", _on_focus_entered)
	$Container/InputContainer/Box/Text.connect("focus_exited", _on_focus_exited)
...
func enable_icon(enabled: bool) -> void:
	...
	if has_node("Container/InputContainer/Box/Icon"):
		if enabled:
			get_node("Container/InputContainer/Box/Icon").show()
		else:
			hide_icon()
...
func set_shadow_size(_size: int) -> void:
	$Container/InputContainer.add_theme_constant_override("shadow_size", _size)
...
func set_font_size(_size: int) -> void:
	...
	if has_node("Container/Top/Name"):
		get_node("Container/Top/Name").add_theme_font_size_override("size", _size)
